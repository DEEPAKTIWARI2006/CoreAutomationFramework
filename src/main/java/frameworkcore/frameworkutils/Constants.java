...
public final class Constants {
   ...
   * 
   */
  public static final String PROJECTNAME = "ALCHEMY_AUTOMATION_SUITE";
  /**
   * 
   */
  public static final String FRAMEWORKCONFIGFILEPATH = System.getProperty("user.dir")
      + "/src/main/resources/propertyFiles/FrameworkConfiguration.properties";
  /**
   * 
   */
  public static final String SNAPSHOTPATH =
      System.getProperty("user.dir") + "Reporting/Screenshots/";
  /**
   * 
   */
  ...
  public static final String EXTENTCONFIGPATH =
      "src/main/resources/propertyFiles/extent-config.xml";
   ...
   * 
   */
  public static final String EXPECTEDJSONFILESPATH =
      "src/test/resources/APIResponseExpectedJsonFiles";
  /**
   * 
   */
   ...
   * 
   */
  public static final String BODYJSONFILESPATH = "src/test/resources/jsonFiles";
