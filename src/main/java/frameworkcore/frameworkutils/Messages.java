...
public final class Messages {
   ...
   * 
   */
  public static final String WEBDRIVER_INIT_FAILURE =
      "Not able to initialize Webdriver. Please check the logs";
  /**
   * 
   */
   ...
   * 
   */
  public static final String EXCELCELLNULL =
      "A cell seems to be blank. Please provide value to the cell";
  /**
   * 
   */
   ...
   * 
   */
  public static final String ASSERTACTUALEXPECTEDFAIL =
      "Expected and Actual do not match. Check the Logs";
